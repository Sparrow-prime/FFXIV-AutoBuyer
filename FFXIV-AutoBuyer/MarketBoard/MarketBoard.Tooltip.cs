...
public partial class MarketBoardModule
{
    ...
    /// <summary>大区（Region）固定为「中国」，见 <see cref="UniversalisApi.ChinaRegionName"/>。</summary>
    private static string GetCurrentRegionName() =>
        UniversalisApi.ChinaRegionName;
